 ...
 **/
export declare const queryByGraphQL: (graphqlApiUrl: string, query: string) => Promise<any>;
/**
...
**/
export declare const fetchLatestBlocksSynced: (graphqlApiUrl: string, includePKBridge: boolean) => Promise<any>;
/**
 ...
 **/
export declare const fetchInterParachainMessageById: (graphqlApiUrl: string, id: string) => Promise<any>;
/**
...
**/
export declare const fetchSyncStatusOfParachain: (graphqlApiUrl: string, paraid: number) => Promise<any>;
//# sourceMappingURL=subsquid.d.ts.map