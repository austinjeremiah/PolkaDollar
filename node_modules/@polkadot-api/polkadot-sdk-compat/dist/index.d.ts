...
declare const fixMissingInitialBest: ParsedJsonRpcEnhancer;
...
declare namespace methods {
  export {
    methods_chainHead as chainHead,
    methods_chainSpec as chainSpec,
    methods_transaction as transaction,
  };
}
...
export { fixDescendantValues, fixMissingInitialBest, fixPrematureBlocks, fixUnorderedBlocks, fixUnorderedEvents, fromParsed, methods, parsed, patchChainHeadEvents, toParsed, translate, unpinHash, withNumericIds, withPolkadotSdkCompat };
export type { ParsedJsonRpcConnection, ParsedJsonRpcEnhancer, ParsedJsonRpcProvider };
