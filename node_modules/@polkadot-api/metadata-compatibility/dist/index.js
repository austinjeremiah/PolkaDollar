...
function isCompatible(value, destNode, getNode) {
  ...
  switch (destNode.type) {
    ...
    case "binary":
      return value != null && typeof value.asBytes === "function" && (destNode.value == null || value.asBytes().length >= destNode.value);
    case "array":
...
exports.isStorageKeyCompatible = isStorageKeyCompatible;
