...
declare function isStorageKeyCompatible(keys: any[], destArgsLen: number, destNode: TypedefNode, getNode: (id: number) => TypedefNode): boolean;
...
export { CompatibilityLevel, EntryPointCodec, TypedefCodec, entryPointsAreCompatible, enumValueEntryPointNode, isCompatible, isStaticCompatible, isStorageKeyCompatible, mapEntryPointReferences, mapLookupToTypedef, mapReferences, runtimeCallEntryPoint, singleValueEntryPoint, storageEntryPoint, valueIsCompatibleWithDest, voidEntryPointNode };
