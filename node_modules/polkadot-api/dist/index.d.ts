...
type TxPromise<Asset, Ext> = (from: PolkadotSigner, txOptions?: TxOptions<Asset, Ext>) => Promise<TxFinalizedPayload>;
type TxObservable<Asset, Ext> = (from: PolkadotSigner, txOptions?: TxOptions<Asset, Ext>) => Observable<TxEvent>;
interface TxCall {
    /**
...
type TxSignFn<Asset, Ext> = (from: PolkadotSigner, txOptions?: TxOptions<Asset, Ext>) => Promise<HexString>;
type PaymentInfo = {
    weight: {
        ref_time: bigint;
        proof_size: bigint;
...
type InnerTransaction<Unsafe, Arg extends {} | undefined, Pallet extends string, Name extends string, Asset, Ext> = {
    /**
...
type Transaction<Arg extends {} | undefined = any, Pallet extends string = string, Name extends string = string, Asset = any, Ext = Record<string, CustomSignedExtensionValues>> = InnerTransaction<false, Arg, Pallet, Name, Asset, Ext>;
type UnsafeTransaction<Arg extends {} | undefined = any, Pallet extends string = string, Name extends string = string, Asset = any, Ext = Record<string, CustomSignedExtensionValues>> = InnerTransaction<true, Arg, Pallet, Name, Asset, Ext>;
type Extensions<D> = D extends {
    extensions: infer Ext extends Record<string, any>;
} ? Partial<Ext> : Record<string, CustomSignedExtensionValues>;
type InnerTxEntry<Unsafe, D, Arg extends {} | undefined, Pallet extends string, Name extends string, Asset> = Unsafe extends true ? {
     ...
     */
    (...args: Arg extends undefined ? [] : [data: Arg]): UnsafeTransaction<Arg, Pallet, Name, Asset, Extensions<D>>;
} : {
    /**
     * Synchronously create the transaction object ready to sign, submit,
     * estimate fees, etc.
     ...
     * @returns Transaction object.
     */
    (...args: Arg extends undefined ? [] : [data: Arg]): Transaction<Arg, Pallet, Name, Asset, Extensions<D>>;
} & CompatibilityFunctions<D>;
